...
```{r}
filter(tree_data, species == "ABBA" | species == "PIST")
```
...
```{r}
filter(tree_data, age > 200, year == 2007)
```
...
Here is an image of each the fastest growing species: ![Pinus Banksiana species (PIBA)](/Users/Avery/github/Lab_2_tree_growth_data/images/PIBA_pinus_banksiana.png) ![Pinus Resinosa species (PIRE)](/Users/Avery/github/Lab_2_tree_growth_data/images/PIRE_pinus_resinosa.png) ![Populus Tremuloides (POTR)](/Users/Avery/github/Lab_2_tree_growth_data/images/POTR_populus_tremuloides.png)
